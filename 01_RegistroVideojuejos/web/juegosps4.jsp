...
<%
    ResultSet filjuegos = (ResultSet) request.getAttribute("datos");
%>
<!DOCTYPE html>
<html lang="es">
                                    ...
                                    <div class="card mb-3 card text-white bg-dark mb-3 card border-info mb-3 card border radius"
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md-4">
                                                <br>
                                                <img
                                                    src="<%=filjuegos.getString("imagen")%>"
                                                    class="card-img" alt="..." border="1">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title"><%=filjuegos.getString("nombre")%></h5>
                                                    <p class="card-text"><%=filjuegos.getString("genero")%></p>
                                                    <p class="card-text"><%=filjuegos.getString("precio")%>€</p>
                                                    <br><br><br>
                                                    <a class="boton_1"
